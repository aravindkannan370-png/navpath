...
function Login() {
  ...
  const handleSubmit = (
    ...
    /*
     * Demo login fallback.
     * This allows an email that has not been
     * registered in this browser to enter the app.
     */
    localStorage.setItem(
      "navpath-user",
      JSON.stringify({
          ...
          <div className="relative z-10 flex w-full flex-col justify-between p-12 xl:p-16">
            ...
            <div className="max-w-xl">
              ...
              <h1 className="text-5xl font-bold leading-tight text-white xl:text-6xl">
                Continue your journey to a maritime career.
              </h1>

              <p className="mt-6 max-w-lg text-lg leading-8 text-slate-300">
                Sign in to continue your IMU CET, DNS and
                Merchant Navy preparation.
              </p>
            </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-slate-500">
                Continue your learning journey with NavPath Academy.
              </p>
            </div>
